      ...
      <div style={{paddingTop: '88px'}}>
        ...
        <div  className="d-flex flex-row other" style={{marginTop: '100px'}}>
          <div className="d-flex flex-column justify-content-center align-items-center col-6">
            ...
            <h2 className="text-center col-6" style={{fontWeight: 'bold', fontSize: '40px'}}>+1000</h2>
            <p className="col-6 text-center" style={{fontSize: '28px', color: '#5C5B5B'}}>Taken from the official Twitter app filtered with several keywords and written in spanish.</p>
          </div>
          <div className="d-flex flex-column justify-content-center align-items-center col-6">
            <h2 className="text-center col-6" style={{fontWeight: 'bold', fontSize: '40px'}}>Accuracy</h2>
            <h2 className="text-center col-6" style={{fontWeight: 'bold', fontSize: '40px'}}>70% Approx</h2>
